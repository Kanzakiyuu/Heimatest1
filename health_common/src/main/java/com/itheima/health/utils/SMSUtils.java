...
public class SMSUtils {
	...
	private static final String ACCESS_KEY="111111111111111"; //你的AccessKey ID
	private static final String SECRET_KEY="11111111111111111111111111"; //你的AccessKey Secret

	public static void main(String[] args) throws ClientException {
//		SMSUtils.sendShortMessage(VALIDATE_CODE,"13652431027","666666");
		SMSUtils.sendShortMessage(VALIDATE_CODE,"18728390089","666666");
	}
